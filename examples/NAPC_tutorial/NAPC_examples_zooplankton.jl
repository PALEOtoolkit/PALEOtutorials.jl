# In this file I have changed the file names on lines 19 and 25 and added extra plots for zooplankton line 71
...
include("NAPC_reactions_zooplankton.jl")
...
model = PB.create_model_from_config(
    joinpath(@__DIR__, "NAPC_cfg_zooplankton.yaml"),
    "NP_shelf";
    modelpars=Dict(
