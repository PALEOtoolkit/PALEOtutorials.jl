...
model = PB.create_model_from_config(
    joinpath(@__DIR__, "NAPC_zoo_cfg.yaml"),
    "NP_shelf";
    modelpars=Dict(
...
pager(heatmap(title="Z0_growth", paleorun.output, "ocean.Z0_feeding_rate", (column=1, ), clim=(0,Inf)))
pager(:newpage) # flush output
