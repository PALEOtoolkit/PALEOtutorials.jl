...
function PB.register_methods!(rj::ReactionPhytoplankton)
    ...
    vars = [
        ...
        PB.VarContrib("O2_conc_sms",    "mol m-3 yr-1",  "Oxygen source-sink"),
        PB.VarDep("P_conc",             "mol m-3",          "Nutrient conc"),
        PB.VarContrib("P_conc_sms",     "mol m-3 yr-1",     "Nutrient source-sink"),
        PB.VarProp("PX_growth_rate",    "yr-1",             "phytoplankton growth rate"),
        PB.VarDep("PX_conc",            "mol m-3",          "phytoplankton concentration"),
        PB.VarContrib("PX_conc_sms",    "mol m-3 yr-1",     "phytoplankton source-sink"),
    ]
...
function grow_phyto(m::PB.ReactionMethod, (vars, ), cellrange::PB.AbstractCellRange, deltat)
    ...
    @inbounds for i in cellrange.indices
        ...
        vars.PX_conc_sms[i] += nutrient_rate
        vars.P_conc_sms[i] -= nutrient_rate
        vars.O2_conc_sms[i] -= rj.pars.stoich_PtoO2.v*nutrient_rate
